    ...
    function deleteById() {
        ...
        if(ids) {
            if(confirm("你确认要删除此条记录吗？")) {
                location.href="${ctx}/store/Catalog/deleteByIds?ids="+ids;
            }
        }else{
    ...
    <div class="box box-primary">
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                        ...
                        <th class="text-center">
                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/store/Catalog/toUpdate?id=${catalog.id}"'>编辑</button>
                        </th>
                    </tr>
                    </c:forEach>
                    </tbody>
        ...
        <div class="box-footer">
            <jsp:include page="../../common/page.jsp">
                <jsp:param value="${ctx}/store/Catalog/findAll" name="pageUrl"/>
            </jsp:include>
        </div>
    </div>
