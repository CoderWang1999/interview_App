        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/store/company/update" method="post">
                ...
                <div class="row data-type" style="margin: 0px">
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="营业执照" name="licenseId" value="${company.license_id}">
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="公司规模" name="companySize" value="${company.company_size}">
                    </div>
