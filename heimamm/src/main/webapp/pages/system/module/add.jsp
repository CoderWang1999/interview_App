    ...
    <div id="frameContent" class="content-wrapper" style="margin-left:0px;">
        ...
        <section class="content">
            <div class="panel panel-default">
                ...
                <form id="editForm" action="${ctx}/system/module/insert" method="post">
                    <div class="row data-type" style="margin: 0px">
                        ...
                        <div class="col-md-4 data">
                            <select class="form-control" onchange="document.getElementById('paentName').value=this.options[this.selectedIndex].text" name="parentId">
