    ...
    function deleteByIds() {
        ...
        if (ids.length>0) {
            if (confirm("你确认要删除此条记录吗？")) {
                location.href = "${ctx}/system/dept/deleteByids?ids=" + ids;
            }
        } else {
        ...
        <div class="box box-primary">
                        ...
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" title="新建"
                                        onclick='location.href="${ctx}/pages/system/dept/add.jsp"'><i
                                        class="fa fa-file-o"></i> 新建
                                </button>
                                <button type="button" class="btn btn-default" title="删除" onclick='deleteByIds()'><i
                            ...
                            <tr>
                                ...
                                <th class="text-center">
                                    <button type="button" class="btn bg-olive btn-xs"
                                            onclick='location.href="${ctx}/system/dept/findById?id=${dept.id}"'>
                                        编辑
                                    </button>
                                </th>
                            </tr>
            ...
            <div class="box-footer">
                <jsp:include page="../../common/page.jsp">
                    <jsp:param value="${ctx}/system/dept/findAll" name="pageUrl"/>
                </jsp:include>
            </div>
        </div>
    </section>
